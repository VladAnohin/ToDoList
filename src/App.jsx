...
export const App = () => {
    ...
    const handleAddTodo = () => {
        ...
        localStorage.setItem('todoList', JSON.stringify(updatedTodoArr)) // эта строка добавляет в локальное хранилище массив постов
    }
    ...
    useEffect(() => {
        let savedTodo = JSON.parse(localStorage.getItem('todoList')) // этот useEffect используется при ререндере массива данных из локального хранилища
